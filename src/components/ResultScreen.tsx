  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center min-h-[100dvh] px-4 py-4 gap-6 md:gap-12 overflow-x-hidden w-full max-w-6xl mx-auto">
      ...
      <div className="flex flex-col items-center justify-center md:w-1/2">
        {/* Raven celebrating */}
        <RavenCharacter mood="victory" size="lg" />
        ...
        >
          <h2 className="font-display text-lg text-muted-foreground mb-1 uppercase tracking-widest text-[#f4f1ea]/70">
            I think of...
          </h2>
          <h1 className="font-display text-2xl md:text-3xl font-bold text-primary text-glow-blood">
            {characterName}
          </h1>
      ...
      <div className="flex flex-col items-center justify-center md:w-1/2 gap-6">
        ...
        >
          ...
          />
          <p className="text-[#f4f1ea]/90 font-body text-sm leading-relaxed">
            {characterDescription}
          </p>
        </motion.div>
        ...
        <button
          onClick={onPlayAgain}
          className="text-accent text-sm font-display tracking-widest uppercase hover:text-white hover:text-glow-gold transition-all mt-2"
        >
          Play again
        </button>
      </div>
